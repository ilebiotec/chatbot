...
namespace CamBot
{
    public class CamBot<T> : ActivityHandler  where T: Dialog
    {
        ...
        public CamBot(UserState userState,ConversationState conversationState, T dialog, IDataBaseService databaseService)
        {
